...
const Home2Banner = () => {
  ...
  return (
    <>
      <div className="home2-banner-section" id="section1">
            ...
            <div className="col-lg-12">
              <div className="banner-content">
                <span>
                  ...
                  Sənədlərinizi rahat və təhlükəsiz idarə edin.
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={14}
                    height={14}
                ...
                <h1>
                BirDoc ilə Sənəd İdarəetmənin Yeni Səviyyəsi
                  {/* <TypeAnimation
  ...
  />
                ...
                <p>
                Sənədlərinizi yükləyin, imzalayın və digər şirkətlərlə paylaşın – hamısı bir platformada.
                </p>
              </div>
            </div>
            <div className="col-lg-10">
              <div className="banner-img d-flex justify-content-center">
                <Image
                  src="/assets/img/home2/Main_Screen_Blue_Svg.svg"
                  alt="Sənəd Dövriyyəsi"
                  width={500}
                  height={500}
                  className="img-fluid"
                  loader={loader}
