...
import azPng from "../../../public/assets/img/azerbaijan.png";
import logo from "../../../public/1doc-logo.svg";
import enPng from "../../../public/assets/img/united-kingdom.png";
        ...
        <div className="sidebar-menu-top-area">
          <div className="container d-flex align-items-center justify-content-between">
            <div className="sidebar-menu-logo">
              <div
                className="logo-dark cursor-pointer"
              ...
              <div className="logo-light" onClick={handleLogoClick}              style={{cursor: 'pointer'}}>
                <Image
                  alt="image"
                  className="img-fluid"
                  src={logo.src}
              ...
              <div className="sidebar-menu-wrap">
                <ul className="main-menu">
                  <li onClick={toggleRightSidebar}>
                    <Link href="#section1">Haqqımızda</Link>
                  </li>
                  <li onClick={toggleRightSidebar}>
                    <Link href="#section2">Həllərimiz</Link>
                  </li>
                  <li onClick={toggleRightSidebar}>
                    <Link href="#section3">Platforma</Link>
                  </li>
                  <li onClick={toggleRightSidebar}>
                    <Link href="#section4">Bizimlə əlaqə</Link>
                  </li>
                </ul>
              </div>
            </div>
      ...
      >
        <div className="container d-flex flex-nowrap align-items-center justify-content-between">
          <div className="company-logo">
            <div className="logo-dark cursor-pointer" onClick={handleLogoClick}              style={{cursor: 'pointer'}}>
              <Image
                alt="image"
                className="img-fluid"
                src={logo.src}
            ...
            <div className="logo-light cursor-pointer" onClick={handleLogoClick}              style={{cursor: 'pointer'}}>
              <Image
                alt="image"
                className="img-fluid"
                src={logo.src}
          ...
          <div className="main-menu d-lg-flex d-none">
            ...
            <ul className="main-menu">
              <li>
                <Link passHref prefetch={false} href="#section1">
                  Haqqımızda
                </Link>
              </li>
              <li>
                <Link passHref prefetch={false} href="#section2">
                  Həllərimiz
                </Link>
              </li>
              <li>
                <Link passHref prefetch={false} href="#section3">
                  Platforma
                </Link>
              </li>
              <li>
                <Link passHref prefetch={false} href="#section4">
                  Bizimlə əlaqə
                </Link>
              </li>
            </ul>
          ...
          <div className="nav-right d-flex jsutify-content-end align-items-center">
            <div className="right-sidebar-and-hotline-area">
              ...
              <div>
                <a
                  href="https://companies.birdoc.az"
