              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="footer-widget">
                  ...
                  <div className="content">
                    <p>
                      "BirDoc ilə sənədlərinizi rahatlıqla idarə edin və
                      təhlükəsizlikdə yeni səviyyəyə çatın. İş proseslərinizi
                      sadələşdirərək, daha məhsuldar olun."
                    </p>
                  </div>
                </div>
              </div>

              <div className="col-lg-3 col-sm-6 d-flex justify-content-lg-end justify-content-sm-end">
                <div className="footer-widget">
                  <ul className="social-list">
                    ...
                    <li>
                      <Link href="#section2">Təkliflərimiz</Link>
                    </li>
                    <li>
          ...
          <div className="contact-area">
            <div className="hotline-area">
              ...
              <div className="content">
                <span>Zəng et</span>
                <h6>
                  <a href="tel:+994-51-521-53-76">+994 51 521 53 76</a>
                </h6>
              </div>
            </div>
            <div className="hotline-area">
              ...
              <div className="content">
                ...
                <h6>
                  <a
                    target="_blank"
                    href="https://maps.app.goo.gl/NmCQqTzN6L9XAGsD7"
                  >
                    Bakı, Azərbaycan
                  </a>
                </h6>
            ...
            <div className="hotline-area">
              ...
              <div className="content">
                <span>Əlaqə</span>
                <h6>
                  <a href="mailto:birdoc.az">birdoc.az</a>
                </h6>
              </div>
            </div>
          </div>
